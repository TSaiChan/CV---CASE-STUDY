...
img_dir = project_dir + "/training_images"
...
tr_cfg = {'resize': [img_shape[0], img_shape[1]], 'scale': 1 / 255.}
tr_preprocessing_fn = functools.partial(_augment, **tr_cfg)

val_cfg = {'resize': [img_shape[0], img_shape[1]], 'scale': 1 / 255.}
val_preprocessing_fn = functools.partial(_augment, **val_cfg)

test_cfg = {'resize': [img_shape[0], img_shape[1]], 'scale': 1 / 255.}
...
test_ds = get_baseline_dataset(x_test_filenames, y_test_filenames, preproc_fn=test_preprocessing_fn, batch_size=batch_size)
